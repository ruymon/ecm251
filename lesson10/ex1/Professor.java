 ...
 * que receba só matrícula e outro que receba todos os parâmetros),
 * métodos de acesso e modificadores e os atributos privados nome,
 * do tipo String, idade, do tipo int e matrícula, do tipo int. Crie
 * o método toString() que retorna o valor dos atributos.
 *
 * Crie os métodos de persistência da classe Professor: inserir,
